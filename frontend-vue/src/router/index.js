...
const routes = [
  { path: '/', redirect: '/chat' },
  { path: '/chat', name: 'chat', component: () => import('../views/ChatView.vue'), meta: { title: '对话中心', tags: ['多轮对话', '任务触发', '历史记录'] } },
  { path: '/dashboard', name: 'dashboard', component: () => import('../views/DashboardView.vue'), meta: { title: '工作台', tags: ['数据概览', '趋势分析', '快速开始'] } },
  { path: '/agents', name: 'agents', component: () => import('../views/AgentsView.vue'), meta: { title: '智能体中心', tags: ['Agent 市场', '自定义编排'] } },
  ...
  { path: '/settings', name: 'settings', component: () => import('../views/SettingsView.vue'), meta: { title: '系统设置', tags: ['模型配置', '外观', '数据管理'] } },
]
